...
if do_cifar:
    ...
    train_data_gen = train_image_gen.flow_from_directory(batch_size=batch_size, directory=root_dir + '/train',
                                                         shuffle=True, target_size=(img_size, img_size),
                                                         class_mode='binary')

    test_data_gen = validation_image_gen.flow_from_directory(batch_size=batch_size,
                                                             directory=root_dir + '/test',
                                                             target_size=(img_size, img_size), class_mode='binary')

    # image_batch, label_batch = test_data_gen.next()
    # print ('size:'+str(len(image_batch)))
    # x_train = np.concatenate((x_train, image_batch))
    # print(label_batch)
